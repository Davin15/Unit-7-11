...
-- 
-- This file animates a character shooting anoother character in a physics world.
-----------------------------------------------------------------------------------------

display.setStatusBar(display.HiddenStatusBar)

display.setDefault( "background", 150/255, 100/255, 200/255 )
...
local sheetIdleKnight = graphics.newImageSheet( "assets/knightIdle2.png",  sheetOptionsIdle )
...
local function ninjaswap (event)
    ...
    -- make a bullet appear
        kunai = display.newImageRect( "assets/bullet.png", 60, 20 )
        kunai.x = ninja.x
        kunai.y = ninja.y
